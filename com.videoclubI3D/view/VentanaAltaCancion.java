...
public class VentanaAltaCancion extends JFrame {
    ...
    private void crearLabel(JPanel panel) {
        ...
        lblAnyo.setBounds(250, 185, 100, 50);
    ...
    private void crearInput(JPanel panel) {
        ...
        panel.add(txtTitulo);
        txtTitulo.setBounds(125, 100, super.getWidth() - 175, 20);

        JTextField txtAutor = new JTextField();
        panel.add(txtAutor);
        txtAutor.setBounds(125, 150, super.getWidth() - 175, 20);

        JSpinner spnDuracion = new JSpinner();
        panel.add(spnDuracion);
        spnDuracion.setBounds(150, 200, 75, 20);
        ...
        cmbAnyo.setBounds(300, 200, 75, 20);
